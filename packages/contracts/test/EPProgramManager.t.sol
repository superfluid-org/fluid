...
contract FluidEPProgramManagerTest is SFTest {
    ...
    function testStartFunding(uint256 _programId, uint256 _fundingAmount, uint32 _duration) external {
...
contract FluidEPProgramManagerLayoutTest is FluidEPProgramManager {
    ...
    function testStorageLayout() external pure {
        ...
        require(slot == 3 && offset == 0, "fluidLockerFactory changed location");
